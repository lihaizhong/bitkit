    ...
    class Tempo {
        ...
        format(value, format = "yyyy/MM/dd hh:mm:ss") {
            ...
            return format.replace(/([yMdhmsqS])+/g, (all, t) => {
                ...
                if (type_checker_1.default.isFunction(fn)) {
        ...
        toRemainTime(value, format = 'd天h小时m分钟s秒') {
            if (!type_checker_1.default.isNumber(+value) || Number.isNaN(value) || Number.isFinite(value)) {
                return '';
            }
        ...
        toDate(value, strict = false) {
            ...
            if (type_checker_1.default.isValidDate(value)) {
