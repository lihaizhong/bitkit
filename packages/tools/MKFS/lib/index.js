 ...
 */
var TransformBean = /** @class */ (function () {
    function TransformBean(config) {
    ...
    TransformBean.setGlobalConfig = function (config) {
        Object.assign(TransformBean.globalConfig, config);
    };
    TransformBean.prototype.transform = function (data) {
        if (data === void 0) { data = {}; }
        var target = {};
        var keys = Object.keys(this).filter(function (key) {
            return Tools.isReservedProperty(key);
        });
    ...
    TransformBean.prototype.valueOf = function () {
        return __assign({}, this.__bean_target__);
    };
    TransformBean.prototype.toString = function () {
        return JSON.stringify(this.__bean_target__);
    };
    TransformBean.Types = { Any: Any };
    TransformBean.globalConfig = {
        looseFields: false,
